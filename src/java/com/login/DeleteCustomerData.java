...
public class DeleteCustomerData extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       PrintWriter out = resp.getWriter();
        try {
            String tid = req.getParameter("c_id");
        ...
        if (ps.executeUpdate() >0) {
            ...
            out.println("alert('Customer data successfully deleted.');");
            out.println("location='admin_pages/view_customer.jsp';");
            out.println("</script>");
            //resp.sendRedirect("");
            //out.print(ps.getResultSet().toString());     
        }else{
            out.println("<script type=\"text/javascript\">");
            out.println("alert('Customer data can't be deleted.');");
            out.println("location='admin_pages/view_customer.jsp';");
            out.println("</script>");
            //out.print(ps.getResultSet().toString());   
        }
