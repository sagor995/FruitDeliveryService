 ...
 * @author SA
 */
@WebServlet("/DeleteOrderData")
public class DeleteOrderData extends HttpServlet{

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       PrintWriter out = resp.getWriter();
        try {
            String tid = req.getParameter("delete_order_id");
        ...
        if (ps.executeUpdate() >0) {
            ...
            out.println("alert('Order data successfully deleted.');");
            ...
            out.println("<script type=\"text/javascript\">");
            out.println("alert('Order data can't be deleted.');");
            out.println("location='admin_pages/view_order.jsp';");
            out.println("</script>");
            //out.print(ps.getResultSet().toString());   
        }
