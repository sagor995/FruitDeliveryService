 ...
 * @author SA
 */
@WebServlet("/DeleteFaqData")
public class DeleteFaqData extends HttpServlet{

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       PrintWriter out = resp.getWriter();
        try {
            String tid = req.getParameter("delete_faq_id");
        ...
        if (ps.executeUpdate() >0) {
            ...
            out.println("alert('F.A.Q successfully deleted.');");
            ...
            out.println("<script type=\"text/javascript\">");
            out.println("alert('F.A.Q can't be deleted.');");
            out.println("location='admin_pages/view_afaq.jsp';");
            out.println("</script>");
            //out.print(ps.getResultSet().toString());   
        }
