...
<!--            <a href="admin_panel.jsp" ><div id="head_img"></div></a>-->
			...
			<div id="left">
                            ...
                            <h5 class="badge badge-danger">Hi!, Wanna Edit Data!!! </h5>
                                        ...
                                        <% String value1 = request.getParameter("edit_type_id");
                                            try{
                                            connection = DriverManager.getConnection(connectionUrl+database, userid, password);
                                            statement=connection.createStatement();
                                            String sql ="select * from types where type_id = "+Integer.parseInt(value1);
                                        ...
                                        <h5 class="badge badge-success">Admin: ${aname_s}</h5>
                                         ...
                                         <form action="../EditType" method="post">
                                             <input type="hidden" name="edit_typ_id" value="<%=Integer.parseInt(value1)%>">
                                            <div class="form-group">
                                                <label for="titleInputEmail1" class="badge badge-light">Product Type</label>
                                                <input type="text" class="form-control" name="etype_name" placeholder="Enter fruit type." value="<%=resultSet.getString("type_title") %>">
                                            </div>
