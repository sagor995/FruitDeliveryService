...
<html>
    <head>
        ...
        <title>FriutEats-EditOrderStatus</title>
...
<!--            <a href="admin_panel.jsp" ><div id="head_img"></div></a>-->
			...
			<div id="left">
                            ...
                            <h5 class="badge badge-danger">Hi!, Wanna Edit Data!!! </h5>
                                        ...
                                        <% String value2 = request.getParameter("edit_order_id");
                                            try{
                                            connection = DriverManager.getConnection(connectionUrl+database, userid, password);
                                            statement=connection.createStatement();
                                            String sql ="select * from invoice_info where id = "+Integer.parseInt(value2);
                                        ...
                                        <h5 class="badge badge-success">Admin: ${aname_s}</h5>
                                         ...
                                         <form action="../EditOderStatus" method="post">
                                             <input type="hidden" name="edit_ord_id" value="<%=Integer.parseInt(value2)%>">
                                            <div class="form-group">
                                                <label for="titleInputEmail1" class="badge badge-light">Product Type</label>
                                                <input type="text" class="form-control" name="status_change" placeholder="Enter Status." value="<%=resultSet.getString("status") %>">
                                            </div>
