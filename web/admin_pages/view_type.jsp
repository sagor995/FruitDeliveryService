...
<!--            <a href="admin_panel.jsp" ><div id="head_img"></div></a>-->
			...
			<div id="left">
                            ...
                            <h5 class="badge badge-danger">Hi!, Here is your Fruits Type data!!!</h5>
                                        ...
                                        <table class="table table-hover table-active">
                                            <thead>
                                              <tr>
                                                ...
                                                <th scope="col" id="col_id">Type Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach items="${rs.rows}" var="row">
                                                    <tr>
                                                       <th scope="row" id="col_id">${row.type_id}</th>
                                                        <th id="col_id">${row.type_title}</th>
                                                        <th id="col_id"><a href="edit_type.jsp?edit_type_id=${row.type_id}" class="btn btn-outline-light">Edit</a></th>
                                                        <th id="col_id">
                                                            <form method="get" action="../DeleteTypeData">
                                                            <input type="hidden" name="delete_type_id" value="${row.type_id}">
