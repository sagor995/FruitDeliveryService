...
<html>
    <head>
        ...
        <title>FriutEats-Edit Images</title>
                                        ...
                                        <h5 class="badge badge-success">Admin: ${aname_s}</h5>
                                         ...
                                         <form action="../EditImages" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                               <label for="typeInputEmail1" class="badge badge-light">Select a type of image which you want to change.</label>
                                              <select name="image_type"  class="form-control">
                                                <option>Site Logo</option>
                                                <option>Header Banner</option>
                                                <option>Center Banner</option>
                                             </select>
                                            </div>
