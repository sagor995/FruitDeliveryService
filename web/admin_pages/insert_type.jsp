                                        ...
                                        <h5 class="badge badge-success">Admin: ${aname_s}</h5>
                                         ...
                                         <form action="../InsertType" method="post">
                                            <div class="form-group">
                                              <label for="typeInput" class="badge badge-light">Fruit Type</label>
                                              <input type="text" class="form-control" name="fruit_type" placeholder="Enter fruit type.">
                                            </div>
                                            <button type="submit" class="btn btn-success">Insert type.</button>
                                          </form>   
