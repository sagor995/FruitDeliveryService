...
<!--            <a href="admin_panel.jsp" ><div id="head_img"></div></a>-->
			...
			<div id="left">
                            ...
                            <h5 class="badge badge-danger">Hi!, Here is your customer messages!!!</h5>
...
<!--                                         <div class="table-container">-->
                                        <table class="table table-hover table-active">
                                            <thead>
                                              <tr>
                                                <th scope="col" id="col_id">M-Id</th>
                                                <th scope="col" id="col_id">C-Ip</th>
                                                <th scope="col" id="col_id">Name</th>
                                                <th scope="col" id="col_id">Email</th>
                                                <th scope="col" id="col_id">Subject</th>
                                                <th scope="col" id="col_id">Message</th>
                                            ...
                                            <tbody>
                                                ...
                                                <sql:query var="rs" dataSource="${db}">select * from messages;</sql:query>
                                                <c:forEach items="${rs.rows}" var="row">
                                                    <tr>
                                                       <th scope="row" id="col_id">${row.id}</th>
                                                        ...
                                                        <th id="col_id">${row.subject}</th>
                                                        <th id="col_id">${row.message}</th>
                                                        <th id="col_id">
                                                            <form method="get" action="../DeleteMessageData">
                                                            <input type="hidden" name="delete_msg_id" value="${row.id}">
