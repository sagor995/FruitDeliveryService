...
<html>
    <head>
        ...
        <title>FriutEats-Edit Slide Images</title>
...
<!--            <a href="admin_panel.jsp" ><div id="head_img"></div></a>-->
			...
			<div id="left">
                            ...
                            <h5 class="badge badge-danger">Hi!, Wanna Edit Site Logo, Banner or Center Images!!!</h5>
                                        <h4 class="badge badge-dark">Try Now!</h4>
                                        <h5 class="badge badge-success">Admin: ${aname_s}</h5>
                                        
                                         <form action="../EditSlideImages" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                               <label for="typeInputEmail1" class="badge badge-light">Select a number of slide which you want to change.</label>
                                              <select name="slide_type"  class="form-control">
                                                ...
                                                <option>Slide 6</option>
                                             </select>
                                            </div>
                                                    
                                            <div class="form-group">
                                                <label for="exampleFormControlFile1" class="badge badge-light">Select a Image</label>
                                                <input type="file" name="change_slide"  class="form-control-file" id="exampleFormControlFile1">
                                            </div>
                                             <span style="margin-bottom: 5px;" class="badge badge-light">Note: Make sure image resolution is 800x300px.</span>
                                             <br>
