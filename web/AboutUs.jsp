                ...
                <div id="products_box" style="margin-left: 20px;margin-right: 20px;margin-top: 30px;margin-bottom: 20px;">
                    ...
                    <div id="main">
                            <div id="top">
                                ...
                                <div id="top-inside">
                                    <center>
                                        <h2 class="badge-light"><b>A Web App Project using JSP & Servlet.</b></h2>
                                    </center>
                                    <h5>Group Members:</h5>
                                    <ul class="list-group">
                                        <li class="list-group-item">Sagor Ahamed</li>
                                        <li class="list-group-item">Nabil Ahmed</li>
                                        <li class="list-group-item">Sarafat Ayon</li>
                                      </ul>
                                </div>
                            </div>
                             <br>
                            <div id="middle">
                                <center><h3 id="about-text1">Details:</h3></center>
                                <div id="text-inside">
                                       <p id="text">FruitEats online Buying in bangladesh with free home delivery. Shop online for Fruits. ✓Cash On Delivery ✓Card</p>
                                       <br>
                                       <br>
