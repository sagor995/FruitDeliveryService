...
<!--                                        <a style="text-align: center;margin-top: 10px;" href="MyAccount.jsp" class="btn btn-outline-warning">View Profile</a>-->
                                ...
                                <div id="left">
                                 ...
                                 <% 
                                String value3 = request.getParameter("order_vid");
           
                                
                                PreparedStatement ps = (PreparedStatement) connection.prepareStatement("SELECT * FROM invoice_info where id=?");
                                ...
                                if (rs.next()) {
                                    %>
                                        <div class="card" style="width: 20rem; margin-top: 10px;margin-bottom: 10px;">
                                            ...
                                            <h4 id="about-text1">Order Details</h4>
                                            </div></center>
                       
                                            <div class="card-body">
                                              <h5 class="card-title"><b>Name: </b><%=rs.getString("card_name")%></h5>
                                              <p class="card-text">Address:</b><%=rs.getString("card_address")%>.</p>
                                            </div>
                                            <ul class="list-group list-group-flush">
                                              <li class="list-group-item"><b>Total Price: </b><%=rs.getString("total_price")%></li>
                                              <li class="list-group-item"><b>Payment Method: </b><%=rs.getString("paid_via")%></li>
                                              <li class="list-group-item"><b>Status: </b><%=rs.getString("status")%></li>
                                              <li class="list-group-item"><b>Date: </b><%=rs.getString("date")%></li>
                                              <li class="list-group-item"><b>Contact: </b><%=rs.getString("phone")%></li>
                                              
                                              
                                              <%
                                                String parts[] =rs.getString("product_names").split(",");
                                                
                                                for (String p : parts) {
                                                   
                                                %>
                                                <li class="list-group-item"><b>Pro ID:<%=p%>:  </b><a href='view_products.jsp?view_pro_id=<%=p%>'>View</a></li>
                                               <% 
                                                    }
                                               %>
                                              
                                              <li class="list-group-item"><b>Quantities: </b><%=rs.getString("product_qtys")%></li>
                                            </ul>
                                            <div class="card-body">
                                                <center><form method="get" action="DeleteOrderUData">
