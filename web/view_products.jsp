...
<!--                                    <input type="text" class="btn btn-outline-success my-2 my-sm-0" name="user_query" placeholder="Search..."/>-->
        ...
        %>                    
            ...
            <div id="content_area">
                            <div id="products_box">
                                        <% 
                                               String value = request.getParameter("view_pro_id");
                                            ...
                                            <br><br>
                                                ...
                                                <div class="card border-dark mb-3" >
                                                    <div class="row no-gutters">
                                                      <div class="col-md-4">
                                                          <img style="margin-left: 20px;margin-top: 20px;" src="fruit/<%=resultSet.getString("product_image") %>" height="300" class="img-thumbnail" alt="...">
                                                      </div>
                                                      <div class="col-md-8">
                                                          <div style="margin-left: 100px;" class="card-body">
                                                          <h5 class="card-title"><%=resultSet.getString("product_title") %></h5>
                                                          <p class="card-text"><b>Price:</b> <%=resultSet.getString("product_price") %> Tk./ <%=resultSet.getString("product_description") %></p>
                                                          <p class="card-text"><small class="text-muted">Keywords:<%=resultSet.getString("product_keyword") %></small></p>
                                                          <p class="card-text"><b>Benefits:</b> Fresh fruits are naturally sweet and pack huge nutritional benefits as well. Fruits act as cleansers for your body, give you energy and supply a vast array of vitamins, minerals and antioxidants that promote good health.
                                                                                                    Adding fruit to your diet is as simple as eating an apple with your lunch or slicing a banana onto your breakfast cereal. Aim to add at least two or three servings to your daily diet to get the numerous benefits fruits have to offer.</p>
<!--                                                          <a style="float: left; margin-bottom: 20px;" href="#" class="btn btn-primary">Add To Cart</a>-->
                                                            <div class="card">
                                                                  <form method="post" action="productAddActionFromView">
                                                                      <input type="hidden" name="pro_id" value="<%=resultSet.getString("product_id") %>"/>
