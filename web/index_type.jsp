...
<!--                                    <input type="text" class="btn btn-outline-success my-2 my-sm-0" name="user_query" placeholder="Search..."/>-->
        ...
        <%
            String value4 = request.getParameter("type_sresult");  
        %>
...
<!--                                    <?php getProducts(); ?>
                                    ...
                                    <sql:query var="rs" dataSource="${db}">select * from products where product_type =(SELECT type_id FROM types WHERE type_title rlike '<%=value4%>');</sql:query>
